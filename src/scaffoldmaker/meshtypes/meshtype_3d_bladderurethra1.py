        ...
        'Cat 1': ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits': exnode_string_from_nodeset_field_parameters(
                ...
                [Node.VALUE_LABEL_VALUE, Node.VALUE_LABEL_D_DS1, Node.VALUE_LABEL_D_DS2, Node.VALUE_LABEL_D2_DS1DS2], [[
                    ...
                    (4, [[0.0000, 0.0000, 45.000], [0.0000, 0.0000, 15.000], [0.0000, 0.5000, 0.00000], [0.0000, 0.0000, -0.5000]]),
                    (5, [[0.0000, 0.1000, 60.450], [0.0000, 1.1000, 13.500], [0.0000, 0.5000, 0.00000], [0.0000, 0.0000, -0.5000]]),
                    (6, [[0.0000, 1.4200, 75.200], [0.0000, 1.4000, 13.200], [0.0000, 0.5000, 0.00000], [0.0000, 0.0000, -0.5000]]),
        ...
        'Human 1': ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits': exnode_string_from_nodeset_field_parameters(
                ...
                [Node.VALUE_LABEL_VALUE, Node.VALUE_LABEL_D_DS1, Node.VALUE_LABEL_D_DS2, Node.VALUE_LABEL_D2_DS1DS2], [[
                    ...
                    (4, [[0.0000,  0.0000, 60.000], [0.0000,  0.0000, 20.000], [0.0000, 0.5000, 0.0000], [0.0000, 0.0000, -0.5000]]),
                    (5, [[0.0000,  0.0000, 80.000], [0.0000,  0.3000, 17.700], [0.0000, 0.5000, 0.0000], [0.0000, 0.0000, -0.5000]]),
                    (6, [[0.0000, -2.1000, 100.60], [0.0000, -1.9000, 17.200], [0.0000, 0.5000, 0.0000], [0.0000, 0.0000, -0.5000]]),
        ...
        'Mouse 1': ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits': exnode_string_from_nodeset_field_parameters(
                ...
                [Node.VALUE_LABEL_VALUE, Node.VALUE_LABEL_D_DS1, Node.VALUE_LABEL_D_DS2, Node.VALUE_LABEL_D2_DS1DS2], [[
                    ...
                    (4, [[0.000,  0.1115, 45.257], [0.0000, -0.0207, 13.330], [0.0000, 0.5000, -0.0026], [0.0000, -0.0015,  0.0336]]),
                    (5, [[0.000, -0.0079, 58.668], [0.0000, -0.0381, 13.242], [0.0000, 0.4996,  0.0196], [0.0000, -0.0040,  0.0453]]),
                    (6, [[0.000,  0.0332, 71.739], [0.0000, -0.2969, 13.684], [0.0000, 0.4983,  0.0403], [0.0000,  0.0013, -0.0227]]),
        ...
        'Pig 1': ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits': exnode_string_from_nodeset_field_parameters(
                ...
                [Node.VALUE_LABEL_VALUE, Node.VALUE_LABEL_D_DS1, Node.VALUE_LABEL_D_DS2, Node.VALUE_LABEL_D2_DS1DS2], [[
                    ...
                    (4, [[0.0000,  0.0421, 48.982], [0.0000, -0.1616, 17.639], [0.0000, 0.5385,  0.0049], [0.0000,  0.0162,  0.0406]]),
                    (5, [[0.0000, -0.0945, 66.965], [0.0000, -0.4986, 17.987], [0.0000, 0.5378,  0.0276], [0.0000, -0.0051,  0.0509]]),
                    (6, [[0.0000, -0.9552, 84.946], [0.0000, -0.6462, 18.734], [0.0000, 0.5374,  0.0334], [0.0000, -0.0173, -0.0718]]),
        ...
        'Rat 1': ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits': exnode_string_from_nodeset_field_parameters(
                ...
                [Node.VALUE_LABEL_VALUE, Node.VALUE_LABEL_D_DS1, Node.VALUE_LABEL_D_DS2, Node.VALUE_LABEL_D2_DS1DS2], [[
                    ...
                    (4, [[0.000,  0.7906, 45.597], [0.0000,  0.0678, 13.290], [0.0000, 0.5000, -0.0026], [0.0000, -0.0060,  0.0568]]),
                    (5, [[0.000,  0.5862, 59.093], [0.0000, -0.5418, 13.798], [0.0000, 0.4969,  0.0553], [0.0000, -0.0080,  0.0623]]),
                    (6, [[0.000, -0.3075, 73.183], [0.0000, -1.1224, 13.895], [0.0000, 0.4921,  0.0884], [0.0000,  0.0061, -0.0646]]),
