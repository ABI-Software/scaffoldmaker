    ...
    centralPathDefaultScaffoldPackages = {
        'Mouse 1' : ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits' : zinc_utils.exnodeStringFromNodeValues(
                ...
                [ [ -16.5,  11.7,  -3.9 ], [ -1.0,  0.2,   5.8 ], [ -0.2, -1.7,  0.2 ], [  0.0,  0.0,  0.5 ] ],
                [ [ -12.5,  11.7,  -1.4 ], [  3.6,  0.1,   0.6 ], [  0.0, -1.5, -0.0 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -6.8,  11.8,  -0.7 ], [  2.9,  0.0,   0.7 ], [ -0.9, -1.6, -0.3 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -6.4,   9.8,  -1.6 ], [ -2.9, -0.3,  -1.4 ], [ -0.9,  1.6,  0.4 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -9.5,   9.5,  -2.9 ], [ -4.6,  0.0,  -1.8 ], [ -0.2,  1.4,  0.7 ], [  0.0,  0.0,  0.5 ] ],
                [ [ -14.3,   9.4,  -4.6 ], [ -3.4,  0.1,  -1.6 ], [ -0.1,  1.6,  0.5 ], [  0.0,  0.0,  0.5 ] ],
                [ [ -19.0,   9.4,  -2.9 ], [  0.3,  0.2,   6.7 ], [  1.0,  1.4,  0.2 ], [  0.0,  0.0,  0.5 ] ],
                [ [ -14.5,   9.7,   0.2 ], [  3.6, -1.2,   1.0 ], [  0.7,  2.2,  0.9 ], [ -0.2,  0.0,  0.2 ] ],
                ...
                [ [ -17.3,   6.9,  -1.0 ], [ -2.5,  0.0,  -0.4 ], [ -1.6,  0.0,  1.7 ], [ -0.1,  0.2,  0.3 ] ],
                [ [ -19.9,   6.8,  -2.5 ], [ -1.5, -1.1,  -3.4 ], [ -1.8, -0.7,  0.4 ], [  0.3, -0.1, -0.2 ] ],
                [ [ -17.2,   6.3,  -5.1 ], [  4.0,  0.8,  -1.3 ], [  0.5, -2.0, -1.7 ], [  0.0,  0.0,  0.5 ] ],
                [ [ -12.2,   7.8,  -6.8 ], [  4.8,  1.7,  -0.3 ], [  0.0, -5.0,  0.0 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -7.9,   9.6,  -6.5 ], [  3.7,  1.7,   0.7 ], [  0.0, -5.0,  0.0 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -3.8,  10.3,  -5.5 ], [  3.8, -2.7,  -0.1 ], [ -1.9, -1.4, -0.3 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -5.3,   7.6,  -6.4 ], [ -3.5, -1.0,  -1.3 ], [ -1.3,  1.6,  0.4 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -9.0,   6.4,  -7.3 ], [ -3.2, -1.3,   1.9 ], [ -0.8,  2.7,  1.3 ], [  0.0,  0.0,  0.5 ] ],
                [ [ -11.6,   4.0,  -2.0 ], [  5.6, -0.2,   4.3 ], [  0.6,  1.8, -0.1 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -5.9,   5.0,  -3.1 ], [  4.1,  1.2,  -1.6 ], [ -1.1,  2.0, -0.8 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -2.5,   6.0,  -3.8 ], [  3.6,  0.7,   3.2 ], [ -0.1,  2.8, -0.3 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -4.1,   3.2,  -0.4 ], [ -3.5, -1.7,   2.6 ], [ -0.4,  2.6,  0.6 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -9.7,   1.7,   2.3 ], [ -7.9, -1.0,   1.0 ], [ -0.4,  3.1,  0.0 ], [  0.0,  0.0,  0.5 ] ],
                [ [ -19.0,   0.6,  -0.4 ], [  0.2,  3.7,  -6.8 ], [  0.7,  3.1,  0.8 ], [  0.0,  0.0,  0.5 ] ],
                [ [ -13.9,   2.3,  -5.8 ], [  4.4,  0.6,  -1.1 ], [  0.2,  2.4,  0.9 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -7.7,   1.2,  -4.6 ], [  3.9, -3.4,   1.5 ], [  2.3,  1.6,  0.7 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -4.8,  -4.0,  -1.3 ], [ -4.2, -3.3,   3.1 ], [  1.8,  0.2,  1.1 ], [  0.0,  0.0,  0.5 ] ],
                [ [ -10.9,  -6.1,  -0.6 ], [ -5.3, -1.2,  -0.9 ], [  0.4, -1.2,  1.6 ], [  0.0,  0.0,  0.5 ] ],
                [ [ -19.9,  -6.4,  -5.5 ], [ -0.3,  1.7, -10.5 ], [  0.8, -2.4, -0.8 ], [  0.0,  0.0,  0.5 ] ],
                [ [ -10.7,  -3.2,  -8.8 ], [  7.8,  0.4,   0.1 ], [  1.0, -2.6,  1.5 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -1.2,  -1.9,  -7.3 ], [  0.8,  8.1,   2.5 ], [  1.3,  0.0,  0.3 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -6.3,   0.5,  -8.1 ], [ -9.8, -1.2,   0.5 ], [  0.4,  1.7, -1.0 ], [  0.0,  0.0,  0.5 ] ],
                [ [ -16.0,  -0.7,  -7.4 ], [ -7.6,  1.2,   1.5 ], [ -0.1,  1.2, -1.7 ], [  0.0,  0.0,  0.5 ] ],
                [ [ -20.5,   2.3,  -6.1 ], [  3.5,  7.2,  -2.9 ], [ -0.1, -0.3, -2.8 ], [  0.0,  0.0,  0.5 ] ],
                [ [ -11.4,   2.6, -10.1 ], [ 10.4,  1.5,  -0.2 ], [  0.2, -0.1, -2.2 ], [  0.0,  0.0,  0.5 ] ],
                [ [  -3.8,   4.2,  -7.3 ], [  3.5,  0.9,   2.7 ], [  0.8,  0.3, -2.2 ], [ -3.4, -7.3, -0.2 ] ] ] )
            } )
        }
