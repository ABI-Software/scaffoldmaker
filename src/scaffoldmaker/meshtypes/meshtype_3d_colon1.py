...
class MeshType_3d_colon1(Scaffold_base):
    ...
    centralPathDefaultScaffoldPackages = {
        ...
        'Human 3': ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits': exnodeStringFromNodeValues(
                [Node.VALUE_LABEL_VALUE, Node.VALUE_LABEL_D_DS1, Node.VALUE_LABEL_D_DS2, Node.VALUE_LABEL_D2_DS1DS2, Node.VALUE_LABEL_D_DS3, Node.VALUE_LABEL_D2_DS1DS3], [
                [ [ -87.21, -111.06,  890.54 ], [  -4.75,   0.41,  12.39 ], [  21.05,  -2.83,  7.13 ], [  2.46, -0.39, -2.95 ], [  2.79, 22.12,  0.41 ], [  1.83,  0.46, -4.31 ] ],
                [ [ -89.99, -110.57,  902.65 ], [  -2.05,   0.53,  12.72 ], [  22.40,  -2.97,  3.74 ], [  0.07,  0.14, -2.81 ], [  3.10, 22.66, -0.58 ], [  0.43,  0.10, -3.97 ] ],
                [ [ -91.25, -110.01,  915.92 ], [  -0.55,   0.53,  13.39 ], [  21.27,  -2.54,  0.97 ], [ -1.46,  0.55, -1.92 ], [  2.57, 21.27, -0.82 ], [ -1.42,  0.54, -2.13 ] ],
                [ [ -91.08, -109.52,  929.39 ], [   0.13,   0.65,  13.47 ], [  19.48,  -1.87, -0.09 ], [ -0.53,  0.22, -1.06 ], [  1.86, 19.46, -1.05 ], [ -0.53,  0.21, -1.17 ] ],
                [ [ -91.00, -108.72,  942.85 ], [   0.83,   0.67,  13.37 ], [  20.22,  -2.11, -1.15 ], [ -0.88,  0.27, -1.85 ], [  2.05, 20.22, -1.27 ], [ -0.92,  0.27, -2.03 ] ],
                [ [ -89.43, -108.18,  956.08 ], [   2.81,   0.32,  13.11 ], [  17.75,  -1.34, -3.78 ], [ -1.96,  0.62, -1.35 ], [  1.22, 18.09, -0.76 ], [ -2.00,  0.62, -1.49 ] ],
                [ [ -85.39, -108.09,  968.92 ], [   3.10,   0.44,  13.08 ], [  16.31,  -0.87, -3.84 ], [ -0.76,  0.32,  0.66 ], [  0.72, 16.68, -0.80 ], [ -0.73,  0.31,  0.71 ] ],
                [ [ -83.24, -107.30,  982.14 ], [   2.05,   0.85,  13.23 ], [  16.22,  -0.70, -2.47 ], [ -0.24,  0.09,  0.57 ], [  0.54, 16.36, -1.26 ], [ -0.21,  0.08,  0.63 ] ],
                [ [ -81.29, -106.40,  995.37 ], [   2.32,   1.34,  13.29 ], [  15.83,  -0.69, -2.70 ], [  0.14,  0.24, -0.11 ], [  0.41, 15.95, -1.86 ], [  0.05,  0.31, -0.57 ] ],
                [ [ -78.60, -104.62, 1008.65 ], [   2.14,  -1.50,  13.27 ], [  16.51,  -0.22, -2.69 ], [ -0.91,  1.85, -0.22 ], [  0.74, 16.43,  3.01 ], [ -0.95,  1.98, -0.15 ] ],
                [ [ -77.17, -109.18, 1020.82 ], [   4.07,  -9.07,   9.68 ], [  14.05,   2.96, -3.13 ], [ -2.15,  4.06,  0.80 ], [ -0.01, 10.40, 10.89 ], [ -1.97,  3.89,  1.43 ] ],
                [ [ -71.19, -121.03, 1025.58 ], [   7.48, -11.42,   0.49 ], [  12.23,   7.97, -0.98 ], [ -1.27,  2.69,  3.17 ], [  0.00,  1.72, 15.29 ], [ -1.27,  2.72,  3.23 ] ],
                [ [ -63.35, -130.56, 1022.18 ], [   7.99,  -9.44,  -3.40 ], [  11.46,   8.59,  3.10 ], [ -0.81,  0.70,  2.42 ], [  0.00, -4.74, 14.55 ], [ -0.91,  0.85,  2.43 ] ],
                [ [ -55.27, -139.84, 1018.80 ], [   8.88,  -8.59,  -3.55 ], [  10.61,   9.36,  3.87 ], [ -1.07,  0.87,  0.81 ], [  0.00, -5.35, 14.33 ], [ -1.09,  0.87,  0.81 ] ],
                [ [ -45.66, -147.66, 1015.10 ], [   9.90,  -7.39,  -3.36 ], [   9.31,  10.33,  4.71 ], [ -1.63,  1.38,  0.03 ], [ -0.01, -5.79, 14.11 ], [ -1.62,  1.36,  0.02 ] ],
                [ [ -35.52, -154.60, 1012.08 ], [  11.08,  -6.08,  -1.98 ], [   7.36,  12.12,  3.95 ], [ -1.99,  1.15,  0.25 ], [ -0.01, -4.33, 14.74 ], [ -1.97,  1.13,  0.24 ] ],
                [ [ -23.71, -159.68, 1011.20 ], [  11.97,  -4.32,  -1.79 ], [   5.34,  12.62,  5.23 ], [ -1.74, -0.44,  2.51 ], [  0.01, -5.34, 14.28 ], [ -1.79, -0.44,  2.52 ] ],
                [ [ -11.72, -163.20, 1008.53 ], [  12.26,  -2.58,  -2.06 ], [   3.87,  11.25,  8.97 ], [ -2.16, -0.11,  1.44 ], [ -0.01, -8.84, 12.28 ], [ -2.14, -0.12,  1.43 ] ],
                [ [   0.67, -164.82, 1007.10 ], [  12.71,  -0.73,  -0.48 ], [   1.02,  12.38,  8.14 ], [ -2.67,  0.76, -0.81 ], [ -0.01, -7.75, 13.06 ], [ -2.58,  0.75, -0.81 ] ],
                [ [  13.53, -164.63, 1007.59 ], [  12.75,   0.98,   0.85 ], [  -1.47,  12.77,  7.36 ], [ -1.75,  0.42, -1.04 ], [ -0.28, -7.05, 13.49 ], [ -1.71,  0.43, -1.04 ] ],
                [ [  26.09, -162.88, 1008.79 ], [  12.63,   1.81,   1.23 ], [  -2.49,  13.21,  6.05 ], [ -2.26, -0.16, -1.14 ], [ -0.39, -5.90, 14.09 ], [ -2.23, -0.14, -1.14 ] ],
                [ [  38.73, -161.01, 1010.04 ], [  11.76,   4.53,   2.77 ], [  -6.00,  12.45,  5.07 ], [ -3.08, -0.42, -3.34 ], [ -0.85, -5.62, 14.19 ], [ -3.12, -0.44, -3.35 ] ],
                [ [  48.79, -154.12, 1014.15 ], [   9.86,   7.10,   4.16 ], [  -8.65,  12.37, -0.62 ], [ -1.93, -0.52, -2.09 ], [ -4.15, -2.21, 15.11 ], [ -1.97, -0.53, -2.09 ] ],
                [ [  58.41, -146.84, 1018.34 ], [   9.34,   7.75,   4.35 ], [  -9.86,  11.41,  0.85 ], [ -1.82, -1.10,  1.29 ], [ -3.19, -3.77, 15.02 ], [ -1.80, -1.06,  1.30 ] ],
                [ [  67.43, -138.64, 1022.84 ], [   7.99,   8.77,   4.67 ], [ -12.30,  10.17,  1.95 ], [ -2.50, -1.97, -0.34 ], [ -2.29, -5.48, 15.73 ], [ -2.59, -2.16, -0.41 ] ],
                [ [  74.34, -129.42, 1027.61 ], [   5.08,   9.97,   3.83 ], [ -14.87,   7.50,  0.22 ], [  0.03, -2.06,  0.33 ], [ -2.33, -5.10, 16.50 ], [ -1.53, -1.17,  0.49 ] ],
                [ [  77.56, -119.25, 1030.43 ], [   5.04,  10.78,  -0.51 ], [ -12.53,   5.98,  2.38 ], [  0.10,  1.23, -1.77 ], [  3.79,  1.01, 17.93 ], [  0.40,  1.97, -2.97 ] ],
                [ [  83.86, -109.53, 1026.21 ], [   6.93,   6.51,  -9.45 ], [ -14.97,  10.33, -3.86 ], [ -2.81,  1.30, -3.77 ], [  6.42, 13.14, 12.02 ], [ -1.24,  0.30, -4.60 ] ],
                [ [  89.55, -108.42, 1013.56 ], [   3.91,   0.86, -13.16 ], [ -18.20,   8.23, -4.87 ], [ -1.85, -1.68,  0.87 ], [  7.52, 18.71,  3.84 ], [ -2.14, -1.95,  1.17 ] ],
                [ [  91.64, -107.83, 1000.37 ], [   1.78,   0.55, -13.27 ], [ -18.73,   6.95, -2.22 ], [ -0.80, -1.12,  1.76 ], [  6.79, 18.82,  1.85 ], [ -0.86, -1.12,  1.92 ] ],
                [ [  93.10, -107.33,  987.04 ], [   1.01,   0.30, -13.42 ], [ -19.80,   6.00, -1.36 ], [ -0.56, -0.65,  1.35 ], [  5.95, 19.84,  0.98 ], [ -0.58, -0.66,  1.49 ] ],
                [ [  93.66, -107.24,  973.55 ], [  -0.02,   1.05, -13.41 ], [ -19.85,   5.64,  0.47 ], [  0.93, -2.25,  1.33 ], [  5.66, 19.79,  1.71 ], [  0.92, -2.27,  1.47 ] ],
                [ [  93.06, -105.25,  960.32 ], [  -0.77,   2.25, -13.20 ], [ -17.96,   1.50,  1.30 ], [  0.92, -2.34,  0.15 ], [  1.70, 17.72,  3.23 ], [  0.93, -2.36,  0.17 ] ],
                [ [  92.12, -102.74,  947.16 ], [  -0.42,   2.82, -13.16 ], [ -18.00,   0.97,  0.78 ], [  0.74, -0.11, -0.85 ], [  1.11, 17.57,  4.15 ], [  0.73, -0.09, -0.94 ] ],
                [ [  92.23,  -99.62,  934.04 ], [   0.47,   1.78, -13.24 ], [ -16.47,   1.28, -0.41 ], [  1.01,  0.01, -1.14 ], [  1.22, 16.31,  2.49 ], [  1.03,  0.02, -1.27 ] ],
                [ [  93.04,  -99.17,  920.86 ], [   1.21,  -0.74, -13.33 ], [ -15.97,   1.00, -1.51 ], [  0.28, -0.61,  0.54 ], [  1.07, 16.00, -0.87 ], [  0.28, -0.69, -0.02 ] ],
                [ [  94.65, -101.12,  907.56 ], [  -0.61,  -1.62, -13.47 ], [ -15.91,   0.05,  0.71 ], [ -0.21, -1.55,  3.28 ], [ -0.04, 15.82, -2.00 ], [ -0.49, -1.71,  2.07 ] ],
                [ [  91.84, -102.35,  894.35 ], [  -3.47,  -1.64, -11.95 ], [ -16.38,  -2.10,  5.05 ], [  0.91, -2.20,  3.65 ], [ -2.64, 16.98, -1.59 ], [ -0.73, -2.58,  3.87 ] ],
                [ [  87.88, -104.31,  883.75 ], [  -5.21,  -2.13, -10.32 ], [ -14.30,  -4.34,  8.12 ], [  2.73, -2.87,  2.50 ], [ -5.97, 18.48, -0.99 ], [  0.46, -3.19,  4.53 ] ],
                [ [  81.45, -106.59,  873.90 ], [  -6.99,  -2.14,  -9.27 ], [ -10.90,  -7.86, 10.04 ], [  0.33, -3.15,  2.69 ], [ -9.26, 19.09,  1.96 ], [  2.23, -2.67,  3.37 ] ],
                [ [  73.98, -108.57,  865.27 ], [  -8.31,  -0.22,  -8.52 ], [ -13.53, -10.65, 13.47 ], [ -1.28, -1.76,  1.51 ], [ -8.01, 18.53,  7.34 ], [  3.18, -1.46,  2.05 ] ],
                [ [  65.06, -106.92,  857.15 ], [  -8.97,   1.81,  -7.69 ], [ -13.39, -11.32, 12.96 ], [  1.28,  0.43, -0.09 ], [ -4.01, 17.55, 11.89 ], [  2.48,  0.16,  0.52 ] ],
                [ [  56.07, -104.97,  849.91 ], [ -10.00,   1.92,  -6.88 ], [ -11.02,  -9.85, 13.27 ], [  2.49,  5.00,  1.79 ], [ -2.03, 16.12, 10.97 ], [  2.28,  4.69,  1.10 ] ],
                [ [  45.11, -103.12,  843.53 ], [ -11.00,   4.81,  -5.26 ], [  -8.40,  -0.98, 16.68 ], [  2.56,  4.66,  2.88 ], [  6.12, 16.27,  4.28 ], [  2.42,  4.35,  0.87 ] ],
                [ [  34.86,  -95.59,  839.81 ], [  -9.59,   8.68,  -2.67 ], [  -5.91,  -0.68, 19.02 ], [  0.94, -0.41,  0.56 ], [ 11.03, 11.58,  3.43 ], [  0.00,  0.16, -0.54 ] ],
                [ [  26.14,  -85.99,  838.23 ], [  -8.26,  10.16,  -2.00 ], [  -6.49,  -1.78, 17.83 ], [ -0.32, -0.12, -0.85 ], [ 12.91,  9.40,  5.55 ], [ -1.05, -0.47,  0.41 ] ],
                [ [  18.39,  -75.31,  835.82 ], [  -8.42,  10.08,  -2.66 ], [  -6.54,  -0.88, 17.32 ], [ -0.56,  0.61,  0.80 ], [ 14.15,  8.98,  5.99 ], [ -0.36, -0.28,  1.59 ] ],
                [ [   9.35,  -65.88,  832.92 ], [ -11.90,  13.24,  -4.28 ], [  -7.61,  -0.56, 19.43 ], [ -0.85,  0.48,  1.28 ], [ 15.89, 10.29,  6.56 ], [ -1.39, -0.78,  1.04 ] ],
                [ [  -5.12,  -48.68,  827.11 ], [ -17.03,  21.16,  -7.34 ], [  -8.07,   0.18, 19.25 ], [ -0.08,  1.01, -1.64 ], [ 15.89, 10.29,  6.56 ], [ -1.39, -0.78,  1.04 ] ] ] ),
