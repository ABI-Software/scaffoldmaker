...
class MeshType_3d_bladder1(Scaffold_base):
    ...
    centralPathDefaultScaffoldPackages_Bladder = {
        ...
        'Human 1': ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits': exnode_string_from_nodeset_field_parameters(
                [Node.VALUE_LABEL_VALUE, Node.VALUE_LABEL_D_DS1, Node.VALUE_LABEL_D_DS2, Node.VALUE_LABEL_D2_DS1DS2, Node.VALUE_LABEL_D_DS3, Node.VALUE_LABEL_D2_DS1DS3], [
                    (1, [[327.63, 0.00, 0.00], [-47.88, 0.00, 0.00], [0.00, -88.19, 0.00], [0.00, -23.50, 0.00], [0.00, 0.00, 44.36], [0.00, 0.00, 43.40]]),
                    (2, [[278.67, 0.00, 0.00], [-50.03, 0.00, 0.00], [0.00, -110.92, 0.00], [0.00, -21.96, 0.00], [0.00, 0.00, 76.66], [0.00, 0.00, 21.20]]),
                    (3, [[227.59, 0.00, 0.00], [-51.46, 0.00, 0.00], [0.00, -132.08, 0.00], [0.00, -0.19, 0.00], [0.00, 0.00, 86.27], [0.00, 0.00, 0.54]]),
                    (4, [[175.76, 0.00, 0.00], [-50.07, 0.00, 0.00], [0.00, -110.99, 0.00], [0.00, 21.84, 0.00], [0.00, 0.00, 77.61], [0.00, 0.00, -13.52]]),
                    (5, [[127.45, 0.00, 0.00], [-47.88, 0.00, 0.00], [0.00, -88.45, 0.00], [0.00, 25.37, 0.01], [0.00, 0.00, 59.56], [0.00, 0.00, -17.92]]),
                    (6, [[80.00, 0.00, 0.00], [-43.73, 0.00, 0.00], [0.00, -60.29, 0.01], [0.00, 26.66, -0.00], [0.00, 0.00, 41.78], [0.00, -0.00, -15.68]]),
                    (7, [[40.00, 0.00, 0.00], [-40.00, 0.00, 0.00], [0.00, -34.89, 0.00], [0.00, 22.31, 0.00], [0.00, 0.00, 27.87], [0.00, -0.00, -11.75]]),
                    (8, [[0.00, 0.00, 0.00], [-40.00, 0.00, 0.00], [0.00, -15.68, 0.00], [0.00, 16.11, 0.00], [0.00, 0.00, 18.27], [0.00, 0.00, -7.44]])]),
            'userAnnotationGroups': [
                {
                    '_AnnotationGroup': True,
                    'dimension': 1,
        ...
        'Rat 1': ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits': exnode_string_from_nodeset_field_parameters(
                [Node.VALUE_LABEL_VALUE, Node.VALUE_LABEL_D_DS1, Node.VALUE_LABEL_D_DS2, Node.VALUE_LABEL_D2_DS1DS2, Node.VALUE_LABEL_D_DS3, Node.VALUE_LABEL_D2_DS1DS3], [
                    (1, [[100.48, -45.49, 0.00], [-10.33, 5.21, 0.00], [-3.02, -6.00, 0.00], [-4.97, -9.64, 0.02], [0.00, 0.00, 2.33], [-0.13, 0.08, 7.40]]),
                    (2, [[89.11, -39.73, 0.00], [-12.39, 6.31, 0.00], [-7.12, -14.00, 0.00], [-3.23, -6.36, 0.01], [0.00, 0.0, 8.59], [0.08, -0.04, 5.11]]),
                    (3, [[75.70, -32.88, 0.00], [-14.66, 7.42, 0.00], [-9.32, -18.43, 0.00], [-1.41, -3.35, 0.00], [0.00, 0.00, 12.34], [0.11, -0.06, 2.78]]),
                    (4, [[59.79, -24.91, 0.00], [-16.16, 7.72, 0.00], [-9.80, -20.51, 0.00], [0.08, -1.04, 0.00], [0.00, 0.00, 13.96], [0.00, 0.00, 0.35]]),
                    (5, [[43.39, -17.45, 0.00], [-16.02, 7.15, 0.00], [-9.15, -20.50, 0.00], [1.53, 2.36, 0.00], [0.00, 0.00, 13.03], [0.00, 0.00, -1.94]]),
                    (6, [[27.76, -10.60, 0.00], [-14.32, 6.10, 0.00], [-6.79, -15.92, 0.00], [3.16, 6.54, 0.00], [0.00, 0.00, 10.13], [0.00, 0.00, -3.58]]),
                    (7, [[14.77, -5.22, 0.00], [-13.88, 5.32, 0.00], [-2.98, -7.76, 0.00], [3.00, 6.71, 0.00], [0.00, 0.00, 5.99], [0.00, 0.00, -3.81]]),
                    (8, [[0.00, 0.00, 0.00], [-15.66, 5.12, 0.00], [-0.87, -2.66, 0.00], [1.21, 3.49, 0.00], [0.00, 0.00, 2.55], [0.00, 0.00, -3.07]])]),
            'userAnnotationGroups': [
                {
                    '_AnnotationGroup': True,
                    'dimension': 1,
