...
class MeshType_3d_bladder1(Scaffold_base):
    ...
    centralPathDefaultScaffoldPackages_Bladder = {
        ...
        'Human 1': ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits': exnodeStringFromNodeValues(
                [Node.VALUE_LABEL_VALUE, Node.VALUE_LABEL_D_DS1, Node.VALUE_LABEL_D_DS2, Node.VALUE_LABEL_D2_DS1DS2, Node.VALUE_LABEL_D_DS3, Node.VALUE_LABEL_D2_DS1DS3], [
                [[290.00, 0.00, 0.00], [-44.96, 0.00, 0.00], [0.00, -64.81, 0.00], [0.00, -29.97, 0.00], [0.00, 0.00, 59.92], [0.00, 0.00, 20.40]],
                [[245.52, 0.00, 0.00], [-44.00, 0.00, 0.00], [0.00, -91.77, 0.00], [0.00, -23.94, 0.00], [0.00, 0.00, 81.38], [0.00, 0.00, 22.52]],
                [[202.00, 0.00, 0.00], [-43.26, 0.00, 0.00], [0.00, -112.75, 0.00], [0.00, -13.06, 0.00], [0.00, 0.00, 104.93], [0.00, 0.00, 14.64]],
                [[159.00, 0.00, 0.00], [-42.00, 0.00, 0.00], [0.00, -117.97, 0.00], [0.00, -0.81, 0.00], [0.00, 0.00, 110.77], [0.00, 0.00, -1.80]],
                [[118.00, 0.00, 0.00], [-39.50, 0.00, 0.00], [0.00, -114.58, 0.00], [0.00, 14.14, 0.00], [0.00, 0.00, 101.68], [0.00, 0.00, -19.91]],
                [[80.00, 0.00, 0.00], [-39.00, 0.00, 0.00], [0.00, -90.47, 0.00], [0.00, 32.32, 0.00], [0.00, 0.00, 71.74], [0.00, 0.00, -30.20]],
                [[40.00, 0.00, 0.00], [-40.00, 0.00, 0.00], [0.00, -49.51, 0.00], [0.00, 41.24, 0.00], [0.00, 0.00, 41.28], [0.00, 0.00, -31.60]],
                [[0.00, 0.00, 0.00], [-40.00, 0.00, 0.00], [0.00, -7.98, 0.00], [0.00, 41.80, 0.00], [0.00, 0.00, 8.55], [0.00, 0.00, -33.86]]]),
                # [[290.00, -124.00, 0.00], [-44.53, 10.62, 2.07], [-14.50, -63.17, 12.12], [-24.99, -23.48, 7.76], [5.15, 10.11, 58.84], [0.77, 5.08, 20.03]],
                # [[245.52, -109.41, 0.00], [-44.22, 18.50, 0.02], [-35.41, -84.66, 21.54], [-16.82, -19.48, 11.08], [7.21, 17.14, 79.23], [3.37, 8.99, 20.76]],
        ...
        'Mouse 1': ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits': exnodeStringFromNodeValues(
                ...
                [[0.00, 0.00, 0.00], [-9.47, 2.52, 0.00], [-0.40, -1.49, 0.00], [-0.23, 0.51, 0.00], [0.00, 0.00, 1.88], [0.00, 0.00, -1.84]]]),
            'userAnnotationGroups': [
                {
                    '_AnnotationGroup': True,
                    'dimension': 1,
        ...
        'Pig 1': ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits': exnodeStringFromNodeValues(
                ...
                [[0.00, 0.00, 0.00], [-65.62, -18.77, 0.00], [3.12, -10.89, 0.00], [-5.36, 15.97, 0.00], [0.00, 0.00, 12.91], [0.00, 0.00, -32.22]]]),
            'userAnnotationGroups': [
                {
                    '_AnnotationGroup': True,
                    'dimension': 1,
        ...
        'Rat 1': ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits': exnodeStringFromNodeValues(
                ...
                [[0.00, 0.00, 0.00], [-15.64, 5.10, 0.00], [-0.87, -2.66, 0.00], [1.21, 3.47, 0.00], [0.00, 0.00, 2.55], [0.00, 0.00, -3.08]]]),
            'userAnnotationGroups': [
                {
                    '_AnnotationGroup': True,
                    'dimension': 1,
