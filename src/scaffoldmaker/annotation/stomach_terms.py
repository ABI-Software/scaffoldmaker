...
stomach_terms = [
    ...
    ("circular-longitudinal muscle interface of pyloric antrum along the greater and lesser curvatures", "ILX:0793094"),
    ("circular-longitudinal muscle interface of pyloric canal along the greater and lesser curvatures", "ILX:0793095"),
