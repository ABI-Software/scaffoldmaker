...
vagus_terms = [
        ("level of superior border of the jugular foramen on the vagal trunk", "None"),
        ("level of inferior border of the jugular foramen on the vagal trunk", "None"),
        ("level of C1 transverse process on the vagal trunk", "None"),
        ("level of angle of mandible on the vagal trunk", "None"),
        ("level of tubercles of the greater horn of hyoid bone on the vagal trunk", "None"),
        ("level of carotid bifurcation on the vagal trunk", "None"),
        ("level of laryngeal prominence on the vagal trunk", "None"),
        ("level of superior border of clavicle on the vagal trunk", "None"),
        ("level of jugular notch on the vagal trunk", "None"),
        ("level of sternal angle on the vagal trunk", "None"),
        ("1 cm superior to esophageal plexus on the vagal trunk", "None"),
        ("level of esophageal hiatus on the vagal trunk", "None"),
        ("level of aortic hiatus on the vagal trunk", "None"),
