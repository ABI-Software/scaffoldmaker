...
body_terms = [
    ...
    ("left", ""), #Adding an ILX term to a core annotation group (left, right, core, shell, dorsal) causes the tests to fail. Seems like they are hardcoded to have an empty string as preferred id
    ...
    ("right", ""), 
    ("shell", ""),
    ("skin epidermis outer surface",  "ILX:0796507", "UBERON:0001003"),
