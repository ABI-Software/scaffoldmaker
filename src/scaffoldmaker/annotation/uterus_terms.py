...
uterus_terms = [
    ...
    ("left serosa of uterus, cervix and vagina", ""),
    ("left serosa of uterus and cervix", ""),
    ...
    ("right serosa of uterus, cervix and vagina", ""),
    ("right serosa of uterus and cervix", ""),
