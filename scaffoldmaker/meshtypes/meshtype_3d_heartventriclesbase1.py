...
class MeshType_3d_heartventriclesbase1(object):
    ...
    def generateBaseMesh(cls, region, options):
        ...
        for e in range(-1, elementsCountAroundRVFreeWall + elementsCountRVHanging + 1):
            ...
            elif e == (elementsCountRVFreeWallRegular + 1):
        ...
        for e in range(elementsCountAroundVSeptum + 1):
            ...
            if e < elementsCountAroundAtrialSeptum:
                ...
                remapEftNodeValueLabel(eft1, [ 6 ], Node.VALUE_LABEL_D_DS1, [ ( Node.VALUE_LABEL_D_DS1, [1] ), ( Node.VALUE_LABEL_D_DS3, []) ])
                ...
                if lo1 == 0:
                    ...
                    remapEftNodeValueLabel(eft1, [ 7 ], Node.VALUE_LABEL_D_DS2, [ ( Node.VALUE_LABEL_D_DS1, [1] ), ( Node.VALUE_LABEL_D_DS3, []) ])
