...
class MeshType_3d_colon1(Scaffold_base):
    ...
    centralPathDefaultScaffoldPackages = {
        'Human 1' : ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits' : zinc_utils.exnodeStringFromNodeValues(
                ...
                [ [   0.0,   0.0,  0.0 ], [ -16.0,  58.0,  0.0 ], [ -24.0,  -6.0, -12.0 ], [ -14.0,  -1.0, -12.0 ] ],
                [ [ -16.0,  61.0,  0.0 ], [  -8.0,  62.0,  0.0 ], [ -22.0,  -4.0,  -8.0 ], [  -4.0,  19.0,  22.0 ] ],
                [ [  -3.0, 123.0,  0.0 ], [  48.0,  12.0,  0.0 ], [ -10.0,  20.0,   8.0 ], [  -6.0,   0.0,  51.0 ] ],
                [ [  30.0, 122.0,  0.0 ], [  40.0,  -3.0,  0.0 ], [  -5.0,   4.0,  29.0 ], [   0.0,   1.0,  24.0 ] ],
                [ [  73.0, 123.0,  0.0 ], [  46.0,  11.0,  0.0 ], [  -2.0,  10.0,  22.0 ], [   5.0,  25.0, -20.0 ] ],
                [ [ 122.0, 129.0,  0.0 ], [  51.0, -36.0,  0.0 ], [  10.0,  17.0,   6.0 ], [   1.0,  -6.0, -35.0 ] ],
                [ [ 139.0,  64.0,  0.0 ], [   2.0, -40.0,  0.0 ], [  20.0,   0.0, -20.0 ], [  15.0,  -1.0, -10.0 ] ],
                [ [ 129.0,  -3.0,  0.0 ], [ -41.0, -30.0,  0.0 ], [   6.0,  -9.0, -14.0 ], [   8.0, -11.0, -13.0 ] ],
                [ [  77.0,   3.0,  0.0 ], [ -30.0,  17.0,  0.0 ], [   1.0, -11.0, -18.0 ], [   4.0, -12.0, -12.0 ] ] ] )
            } ),
        'Human 2' : ScaffoldPackage(MeshType_1d_path1, {
            ...
            'meshEdits' : zinc_utils.exnodeStringFromNodeValues(
                ...
                [ [   0.0,   0.0,   0.0 ], [ -16.0,  58.0,   0.0 ], [ -24.0,  -6.0, -12.0 ], [ -14.0,  -1.0, -12.0 ] ],
                [ [ -16.0,  61.0,   0.0 ], [  -8.0,  62.0,   0.0 ], [ -22.0,  -4.0,  -8.0 ], [  -4.0,  19.0,  22.0 ] ],
                [ [  -3.0, 123.0,   0.0 ], [  38.0,  -4.0,  26.0 ], [ -10.0,  20.0,   8.0 ], [  -6.0,   0.0,  51.0 ] ],
                [ [  36.0, 104.0,  23.0 ], [  44.0,  39.0,  14.0 ], [  -5.0,   4.0,  29.0 ], [   0.0,   1.0,  24.0 ] ],
                [ [  95.0, 117.0,  24.0 ], [  59.0,  -6.0,  20.0 ], [  -2.0,  10.0,  22.0 ], [   5.0,  25.0, -20.0 ] ],
                [ [ 129.0, 173.0, -11.0 ], [  18.0, -15.0, -55.0 ], [  10.0,  17.0,   6.0 ], [   1.0,  -6.0, -35.0 ] ],
                [ [ 146.0,  78.0, -15.0 ], [  -2.0, -38.0,  -1.0 ], [  20.0,   0.0, -20.0 ], [  15.0,  -1.0, -10.0 ] ],
                [ [ 129.0,  -3.0,   0.0 ], [ -41.0, -30.0,   0.0 ], [   6.0,  -9.0, -14.0 ], [   8.0, -11.0, -13.0 ] ],
                [ [  77.0,   3.0,   0.0 ], [ -30.0,  17.0,   0.0 ], [   1.0, -11.0, -18.0 ], [   4.0, -12.0, -12.0 ] ] ] )
            } ),
    ...
    def getDefaultOptions(cls, parameterSetName='Default'):
        ...
        options = {
            ...
            'Proximal length': 120.0,
            'Transverse length': 130.0,
            'Distal length': 200.0,
            'Proximal inner radius': 8.0,
            'Proximal tenia coli width': 2.0,
            'Proximal-transverse inner radius': 11.0,
            'Proximal-transverse tenia coli width': 2.0,
            'Transverse-distal inner radius': 12.5,
            'Transverse-distal tenia coli width': 2.0,
            'Distal inner radius': 15.0,
            'Distal tenia coli width': 2.0,
            'Refine' : False,
