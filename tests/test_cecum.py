...
class CecumScaffoldTestCase(unittest.TestCase):
    ...
    def test_cecum1(self):
        ...
        self.assertEqual(1252, mesh3d.getSize())
        mesh2d = fieldmodule.findMeshByDimension(2)
        self.assertEqual(5017, mesh2d.getSize())
        mesh1d = fieldmodule.findMeshByDimension(1)
        self.assertEqual(6287, mesh1d.getSize())
        nodes = fieldmodule.findNodesetByFieldDomainType(Field.DOMAIN_TYPE_NODES)
        self.assertEqual(2522, nodes.getSize())
        ...
        assertAlmostEqualList(self, minimums, [-49.01602978165163, -46.896253729833276, -2.0], 1.0E-6)
        assertAlmostEqualList(self, maximums, [42.18397974244375, 54.906723342953256, 180.0], 1.0E-6)
        ...
        self.assertAlmostEqual(surfaceArea, 65800.2656669658, delta=1.0E-6)
        result, volume = volumeField.evaluateReal(fieldcache, 1)
        self.assertEqual(result, RESULT_OK)
        self.assertAlmostEqual(volume, 127049.69543528013, delta=1.0E-6)
