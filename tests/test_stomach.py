...
class StomachScaffoldTestCase(unittest.TestCase):
    ...
    def test_stomach1(self):
        ...
        self.assertEqual(20, options.get("Number of elements around duodenum"))
        ...
        self.assertEqual(1572, mesh3d.getSize())
        mesh2d = fieldmodule.findMeshByDimension(2)
        self.assertEqual(5208, mesh2d.getSize())
        mesh1d = fieldmodule.findMeshByDimension(1)
        self.assertEqual(5706, mesh1d.getSize())
        nodes = fieldmodule.findNodesetByFieldDomainType(Field.DOMAIN_TYPE_NODES)
        self.assertEqual(2090, nodes.getSize())
        ...
        assertAlmostEqualList(self, minimums, [-0.77, -0.42, -0.36293353103307363], 1.0E-6)
        assertAlmostEqualList(self, maximums, [0.780854631116736, 0.8713406657835177, 0.3629335310330727], 1.0E-6)
        ...
        assertAlmostEqualList(self, minimums, [-1.3, -0.5014130864747104, -0.5014130864747104], 1.0E-4)
        assertAlmostEqualList(self, maximums, [0.7, 0.8, 0.5014130864747104], 1.0E-4)
        ...
        self.assertAlmostEqual(surfaceArea, 4.109097109853743, delta=1.0E-6)
        result, volume = volumeField.evaluateReal(fieldcache, 1)
        self.assertEqual(result, RESULT_OK)
        self.assertAlmostEqual(volume, 0.05866824043828919, delta=1.0E-6)
...
#
        ...
        for name in expectedSizes3d:
            ...
            if name == "cardia of stomach":
                self.assertEqual(expectedSizes3d[name] * 32, size, name)
            elif name == "stomach":
                self.assertEqual(expectedSizes3d[name] * 64 - expectedSizes3d["cardia of stomach"] * 32, size, name)
            else:
        ...
        self.assertEqual(8832, element.getIdentifier())
