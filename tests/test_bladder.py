...
class BladderScaffoldTestCase(unittest.TestCase):
    ...
    def test_bladder1(self):
        ...
        self.assertAlmostEqual(surfaceArea, 3.5585227983309387, delta=1.0E-8)
        result, volume = volumeField.evaluateReal(fieldcache, 1)
        self.assertEqual(result, RESULT_OK)
        self.assertAlmostEqual(volume, 0.02520082096589023, delta=1.0E-8)
        ...
        cache.setNode(node)
        element, xi = markerLocation.evaluateMeshLocation(cache, 3)
        self.assertEqual(49, element.getIdentifier())
        assertAlmostEqualList(self, xi, [0.0, 0.0, 1.0], 1.0E-10)
