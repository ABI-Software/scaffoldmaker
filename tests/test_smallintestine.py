...
class SmallIntestineScaffoldTestCase(unittest.TestCase):
    ...
    def test_smallintestine1(self):
        ...
        assertAlmostEqualList(self, minimums, [ -20.06084015913645, 11.403274743489126, -7.1653294859433965 ], 1.0E-6)
        ...
        self.assertAlmostEqual(surfaceArea, 171.274550453658, delta=1.0E-6)
        result, volume = volumeField.evaluateReal(fieldcache, 1)
        self.assertEqual(result, RESULT_OK)
        self.assertAlmostEqual(volume, 16.352310995691198, delta=1.0E-6)
        result, flatSurfaceArea = flatSurfaceAreaField.evaluateReal(fieldcache, 1)
        self.assertEqual(result, RESULT_OK)
        self.assertAlmostEqual(flatSurfaceArea, 171.5282401618693, delta=1.0E-3)
